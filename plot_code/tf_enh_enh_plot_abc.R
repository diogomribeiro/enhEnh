...
enhEnhData = fread("~/git/enhEnh/source_data/abc_enhancers/enh_enh_correlation_remap_abc.tsv.gz", header = T, sep = "\t")
signData = fread("~/git/enhEnh/source_data/abc_enhancers/significant_enh_enh_abc.tsv.gz", header = T, sep = "\t")
...
## Distance-Matched 
match = fread("~/git/enhEnh/source_data/abc_enhancers/sign_nonsign_enh_enh_match_abc.txt.gz")
