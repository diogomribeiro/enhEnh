...
geneBackground = fread("../../source_data/pbmc_dataset/pbmc_gene_enhancer_frequency_positive.tsv.gz")
...
## Significant enh-enh
enhEnhData = fread("../../source_data/pbmc_dataset/pbmc_significant_enh_enh_positive.tsv.gz", header = T, sep = "\t")
...
observed = fread("../../source_data/pbmc_dataset/pbmc_gene_enhancer_frequency_positive.tsv.gz", header = T, sep = "\t")
