...
enhEnhData = fread("/work/FAC/FBM/DBC/odelanea/glcoex/dribeiro/single_cell/enh_enh_paper/data/gene_enhancer_combinations.out", header = T, sep = "\t") 
...
mergedData[is.na(obs)]$observed = 0
